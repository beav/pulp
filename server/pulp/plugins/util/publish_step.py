...
class PluginStep(Step):
    """
    Common functionality for publish and sync. You probably want to use PublishStep or SyncStep.
    """

    def __init__(self, step_type, repo=None, conduit=None, config=None, plugin_type=None,
                 working_dir=None):
        """
        Set the default parent, step_type and unit_type for the the publish/sync step
        ...
        :param publish_conduit: The conduit for the repo
        :type publish_conduit: RepoPublishConduit or RepoSyncConduit
    ...
    def _build_final_report(self):
        ...
        Note that PublishReport is also used for sync reporting.
