...
class SyncStep(PluginStep):
    ...
    def __init__(self, step_type, repo=None, sync_conduit=None, config=None, plugin_type=None):
        """
        ...
        """
        super(SyncStep, self).__init__(step_type, repo=repo, conduit=sync_conduit, config=config,
